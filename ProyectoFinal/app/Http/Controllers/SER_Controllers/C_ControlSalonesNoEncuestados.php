...
class C_ControlSalonesNoEncuestados extends Controller
{
    //
    public function index(Request $request)
    {
        ...
        $respuestas =E_Respuesta:: with('asignatura')
                    ...
                    ->paginate(25);
        return view('/SER_Vistas/SalonesNoEncuestados/SalonesNoEncuestados',compact('respuestas','carreras','años'));
    }
}
