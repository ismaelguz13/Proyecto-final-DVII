...
@endif
    ...
    <h1 id="title">Eliminar Asignatura</h1>

    <br>

    <form action="/menu/est/modificarPlan/eliminar" method="post" id="asignueva">
    @csrf
    <div class="row">
    <div class="col-3">
    ...
    <div class="col-12 d-flex justify-content-between">
        ...
        <button type="submit" form="asignueva" class="btn btn-success">Eliminar</a>
    </div>
    </div>
@endsection