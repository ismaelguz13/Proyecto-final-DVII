                    ...
                    <table class="table table-hover">
                     <!------------COLUMNAS DE LA TABLA EMPRESARIO---------------->
                        <thead class="text-center">
                          ...
                          <!-----------------IMPRIME LOS DATOS------------>
                        <tbody id="tabla_empre" class="text-center"> <!----ID para buscar dato---->
                            ...
                            <tr>
                                ...
                                <td>{{$datos_empre->telefono}}</td>
                                  <!--------BOTON DE MODIFICAR------>
                                <td><a href="{{route('nav_up_empre',$datos_empre->id_empresario)}}" ><i class="far fa-2x fa-edit text-primary"></i></a>
                                </td>                                
                            </tr>
                            @endforeach  
                        </tbody>
