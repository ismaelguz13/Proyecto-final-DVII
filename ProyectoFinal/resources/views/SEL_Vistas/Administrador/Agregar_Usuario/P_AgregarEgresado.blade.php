...
<!------METODO POST PARA GUARDAR LOS DATOS DEL EGRESADO -------->
<form method="POST" action={{route('nav_new_egre')}}>
    {{ csrf_field()}}
    {{ method_field('PUT')}}

<!------MENSAJE PARA VALIDAR LOS CAMPOS DEL EGRESADO-------->
    ...
    <div class="col-sm-10 col-md-10 col-lg-10 mx-auto"><br>
        <div class="container-sm  container-md container-lg">
            ...
            <select class="form-control" name="rol">
                <option value="10">Egresado</option>

            </select><br>
             <label for="">Encuesta</label>
            <select class="form-control" name="encuesta">
                <option value="3">Encuesta de Egresado</option>
            </select><br>
        ...
        <!------SELECCION DE LA SEDE------->
            ...
            <option value="">Seleccionar la sede</option>
                @foreach(App\SEL_Modelos\E_Sede::all() as $dato_sede) 
