...
@section('secciones')
<!------METODO POST PARA GUARDAR LOS DATOS DEL ADMINISTRADOR -------->
    ...
    <div class="col-sm-10 col-md-10 col-lg-10 mx-auto"><br>
        <div class="container-sm  container-md container-lg">
            <h3 class="tit1" >Ingrese los datos del administrador</h3>
                ...
                <!------SELECCION DEL ROL USUARIO -------->
                <label for="">Rol</label>
                <select class="form-control" name="rol">
                    <option value="">Seleccionar rol</option>
                    @foreach(App\SEL_Modelos\E_Rol::get()->take(7) as $dato_rol) 
                    <option value="{{ $dato_rol->id_rol_usuario }}">{{$dato_rol->nombre}}</option>
                    @endforeach
                </select><br>
